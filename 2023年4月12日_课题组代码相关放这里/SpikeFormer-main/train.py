...
def Train(trainData, validData, model, optimizer, epoch, start_epoch, metrics, saveRoot, perIter):
    ...
    # vggloss = Loss.VGGLoss4('vgg19-low-level4.pth').cuda() #murat
    vggloss = Loss.VGGLoss4('/home/mulati/Murat/Group/脉冲图像重构代码/SpikeFormer-main/vgg19-low-level4.pth').cuda()
...
if __name__ == "__main__":
    os.chdir('/home/mulati/Murat/Group/脉冲图像重构代码/SpikeFormer-main/')  #murat 2023年3月5日
    dataPath = "/home/mulati/Murat/Group/脉冲图像重构代码/SpikeFormer-main/Dataset"  #murat 2023年3月5日
    ...
    start_epoch = 0
    lr = 2e-4
    # saveRoot = "CheckPoints/"  # path to save the trained model   #murat
    saveRoot = "/home/mulati/Murat/Group/脉冲图像重构代码/SpikeFormer-main/CheckPoints/"  #murat 2023年3月5日 # path to save the trained model
    perIter = 20

    reuse = False
    reuseType = 'latest'  # 'latest' or 'best'
    checkPath = os.path.join('/home/mulati/Murat/Group/脉冲图像重构代码/SpikeFormer-main/CheckPoints', '%s.pth' % (reuseType))
